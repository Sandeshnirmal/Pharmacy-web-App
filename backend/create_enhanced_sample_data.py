    ...
    for i, scenario in enumerate(prescription_scenarios):
        ...
        for j, medicine in enumerate(scenario['medicines']):
            ...
            detail = PrescriptionDetail.objects.create(
                ...
                ai_extracted_medicine_name=medicine['name'],
                ai_extracted_dosage=medicine['dosage'],
                ai_extracted_frequency=medicine['frequency'],
                ai_extracted_duration=medicine['duration'],
                ai_extracted_instructions=f"{medicine['frequency']} {medicine['duration']}",
